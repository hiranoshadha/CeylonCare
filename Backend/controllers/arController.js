...
const getARRecommendations = async (req, res) => {
  ...
  try {
    const response = await axios.get(`http://192.168.78.225:5000/healthData/${userId}`);
    ...
    const flaskResponse = await axios.post("http://192.168.78.225:5001/predict", userHealthData);
